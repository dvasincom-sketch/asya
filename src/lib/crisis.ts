...
export const CRISIS_REPLY: CrisisReply = {
  type: "crisis",
  text:
    "Спасибо, что сказала мне это. Я слышу, как тебе сейчас невыносимо тяжело — и я рядом. Ты не должна быть с этим одна. Рядом есть люди, которые умеют помочь именно в такие моменты 🤍",
  contacts: [
